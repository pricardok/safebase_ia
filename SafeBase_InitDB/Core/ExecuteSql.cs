...
namespace InitDB.Client
{
    public static class ExecuteSql
    {
        ...
        public static void InsertIntoPostLogQueue(string Message)
        {
            String commandText = "INSERT INTO dbo.LogQueue (XMLMessage) VALUES (@xmlMessage)";
            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection("context connection=true"))
                {
                    ...
                    command.Parameters.Add(
                                            new SqlParameter("@xmlMessage", SqlDbType.Xml)
                                            {
                                                Value = new SqlXml(new XmlTextReader(XMLMessage.InnerXml, XmlNodeType.Document, null))
                                            }
                                          );
            ...
            {
                SendMessage.PostBack("Error Inserting in PostLogQueue: " + ex.Message);
            }
        }

        public static String ExecuteQueryReadFast(string OperationUID, string scriptLine)
        {
