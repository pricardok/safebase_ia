    ...
    class stpAlertaAlteracaoDB
    {
        public static string Query()
        {
            ...
            @"
              ...
              DECLARE @Id_AlertaParametro INT = (SELECT Id_AlertaParametro FROM [dbo].AlertaParametro (NOLOCK) WHERE Nm_Alerta = 'Alteracao database' AND Ativo = 1)
