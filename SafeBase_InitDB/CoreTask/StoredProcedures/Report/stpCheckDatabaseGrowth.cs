...
{
    class stpCheckDatabaseGrowth
    {
        public static string Query()
        {
            return
            //@"insert into [dbo].[Testedb] ([Nome],[DateTest]) values ('Teste da ferramenta DB - stpCheckDatabaseGrowth',GETDATE())";
            @"  SET NOCOUNT ON
	            ...
	            */
	            ...
	            CREATE TABLE #CheckDatabaseGrowth (
	            ...
	            INSERT INTO #CheckDatabaseGrowth
	            ...
	            INSERT INTO [dbo].[CheckDatabaseGrowth] ( [Nm_Servidor], [Nm_Database], [Tamanho_Atual], [Cresc_1_dia], [Cresc_15_dia], [Cresc_30_dia], [Cresc_60_dia] )
	            ...
	            FROM #CheckDatabaseGrowth

	            IF (@@ROWCOUNT <> 0)
	            BEGIN
		            INSERT INTO [dbo].[CheckDatabaseGrowthEmail] ( [Nm_Servidor], [Nm_Database], [Tamanho_Atual], [Cresc_1_dia], [Cresc_15_dia], [Cresc_30_dia], [Cresc_60_dia] )
		            SELECT	TOP 10
