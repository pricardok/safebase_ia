...
{
    class stpCheckSQLTraceLogQueries
    {
        public static string Query()
        {
            return
            // @"insert into [dbo].[Testedb] ([Nome],[DateTest]) values ('Teste da ferramenta DB - stpCheckSQLTraceLogQueries',GETDATE())";
            @"
                SET NOCOUNT ON
	            ...
	            FROM [dbo].[ResultadoTraceLog] (nolock)
