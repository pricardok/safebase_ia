...
{
    class stpCargaHistoricoWaitsStats
    {
        public static string Query()
        {
            return
            // @"insert into [dbo].[Testedb] ([Nome],[DateTest]) values ('Teste da ferramenta DB - stpCargaHistoricoWaitsStats',GETDATE())";
            @"      SET NOCOUNT ON
	                ...
	                if exists	(
					                ...
					                join @Waits_Before C on A.WaitType COLLATE Latin1_General_CI_AI = C.WaitType and A.WaitCount < C.WaitCount 
