...
public partial class StoredProcedures
{
    ...
    public static void stpImportaCSV(SqlString Ds_Caminho_Arquivo, SqlString Ds_Separador, SqlBoolean Fl_Primeira_Linha_Cabecalho, SqlInt32 Nr_Linha_Inicio, SqlInt32 Nr_Linhas_Retirar_Final, SqlString Ds_Tabela_Destino, SqlString Ds_Codificacao)
    {
        ...
        try
        {
            ...
            if (nrLinhaInicioLeitura > nrLinhas)
                Retorno.Erro("O parâmetro Nr_Linhas_Inicio é maior que a quantidade total de linhas do arquivo.");
