...
public partial class StoredProcedures
{
    ...
    public static void stpHistoricoErrosDB()
    {
        // Create the command
        ...
        myCommand.CommandText =
              @"
                    ...
                    ADD TARGET package0.event_file(SET filename = N'C:\Data\Logs\CapturaErrosSistema', max_rollover_files = (0))
                    ...
                    ; WITH CTE AS(
                         ...
                         FROM sys.fn_xe_file_target_read_file(N'C:\Data\Logs\CapturaErrosSistema*.xel', NULL, NULL, NULL)
                     )
                    SELECT
