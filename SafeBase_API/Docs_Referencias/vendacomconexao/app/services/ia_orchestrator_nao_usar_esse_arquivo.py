...
class IAOrchestrator:
    ...
    def get_globally_sorted_keys(self) -> List[Dict]:
        ...
        for provider in active_providers:
            ...
            for key in keys_for_provider:
                ...
                key['key_priority'] = key.pop('ordem_prioridade') # Renomeia a chave para corresponder ao modelo
    ...
    def mark_key_failure(self, chave_id: int, erro: str = ""):
        ...
        try:
            ...
            max_failures = int(max_failures_str) if max_failures_str and max_failures_str.isdigit() else 3
    ...
    def call_provider(self, provider_name: str, api_key: str, prompt: str, config_modelo: Optional[Dict] = None) -> Optional[str]:
        """
